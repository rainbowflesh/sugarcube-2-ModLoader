import type { SC2DataManager } from "../../dist/dist-BeforeSC2/SC2DataManager";
import type { ModUtils } from "../../dist/dist-BeforeSC2/Utils";
import type {
  SC2DataInfoCache,
  PassageDataItem,
} from "../../dist/dist-BeforeSC2/SC2DataInfoCache";
import type { SC2DataInfo } from "../../dist/dist-BeforeSC2/SC2DataInfoCache";
import type {} from "../../src/BeforeSC2/global";
import { WikifyTracerCallback } from "../../dist/dist-BeforeSC2/WikifyTracer";
import { SC2Passage } from "../../dist/dist-BeforeSC2/SC2ApiRef";
